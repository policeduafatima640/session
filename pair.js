...
router.get('/', async (req, res) => {
    ...
    async function KAMRAN_XD_PAIR_CODE() {
            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Don't Share with anyone this code use for deploying KAMRAN XD*\n\n ◦ *Github:* https://github.com/KAMRAN-XD/KAMRAN-XD`;
